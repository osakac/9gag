    ...
    <div class="modal" @click.stop>
      <div class="modal__header">
	    ...
	    <div class="modal__content">
		    <input class="modal__input" type="text" placeholder="Username or email address">
		    <input class="modal__input" type="password" placeholder="Password">

		    <button class="modal__button">Log in</button>

        <p class="modal__footer">Don't have an account?
	        <button class="modal__footer-btn" @click="$emit('switch-modal')">Sign Up</button></p>
      </div>
    </div>
  </div>
</template>
